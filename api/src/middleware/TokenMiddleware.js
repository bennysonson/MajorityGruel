...
const TOKEN_COOKIE_NAME = "MealDeciderToken";
...
exports.generateToken = (req, res, user) => {
  ...
  let data = {
    user: user,
    // Use the exp registered claim to expire token in 24 hour
  ...
  res.cookie(TOKEN_COOKIE_NAME, token, {
    httpOnly: true,
    secure: true,
    maxAge: 24 * 60 * 60 * 1000 //This session expires in 24 hours.. but token expires...
  });
};
